        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetRoles_AspNetUsers_MemberId",
                        column: x => x.MemberId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GameCoverPhoto = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Game_Categories", x => x.GameCategoryId);
                    table.ForeignKey(
                        name: "FK_Game_Categories_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "CategoryId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Game_Categories_Games_GameId",
                        column: x => x.GameId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PurchasedGames_AspNetUsers_MemberId",
                        column: x => x.MemberId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Game_Categories_CategoryId",
                table: "Game_Categories",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_Game_Categories_GameId",
                table: "Game_Categories",
                column: "GameId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchasedGames_MemberId",
                table: "PurchasedGames",
                column: "MemberId");
        }
